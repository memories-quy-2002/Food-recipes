...
const SuggestionPanel = ({ mode = "ingredient_match", recipeId, isAuthenticated = false, allowPersonalized = false }) => {
	...
	return <Card as="section" className="mx-auto w-full max-w-6xl overflow-hidden p-5 sm:p-6 lg:p-8" aria-labelledby="suggestion-panel-title">
