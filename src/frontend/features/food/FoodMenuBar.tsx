...
const FoodMenuBar = ({
	...
	return (
		<Card as="aside" className="sticky top-24 overflow-hidden p-4">
			...
			<form role="search" className="mb-5 grid gap-2" onSubmit={(event) => event.preventDefault()}><label htmlFor="food-search" className="text-sm font-bold">Search recipes</label><Input id="food-search" type="search" name="search_recipe" placeholder="Name or keyword…" value={searchTerm} onChange={onChangeSearchTerm} /></form>
