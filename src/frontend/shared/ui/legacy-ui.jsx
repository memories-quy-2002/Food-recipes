...
import ButtonPrimitive from "@/shared/ui/Button";
...
const mapButtonVariant = (variant) => {
	...
	if (String(variant).startsWith("outline")) return "outline";
	return "default";
};
...
const FormGroup = React.forwardRef(({ as: Component = "div", className, ...props }, ref) => (
	<Component ref={ref} className={cn("min-w-0", className)} {...props} />
));
FormGroup.displayName = "Form.Group";

const FormLabel = React.forwardRef(({ className, ...props }, ref) => (
	<label ref={ref} className={cn("mb-1 block text-sm font-semibold text-foreground", className)} {...props} />
));
...
const FormText = React.forwardRef(({ className, ...props }, ref) => (
	<small ref={ref} className={cn("text-sm text-muted-foreground", className)} {...props} />
));
FormText.displayName = "Form.Text";

const FormFeedback = React.forwardRef(({ type = "invalid", className, ...props }, ref) => (
	<div
		ref={ref}
		className={cn(
...
export const Pagination = Object.assign(PaginationRoot, {
	...
	First: React.forwardRef((props, ref) => <PaginationButton ref={ref} {...props}>«</PaginationButton>),
	Prev: React.forwardRef((props, ref) => <PaginationButton ref={ref} {...props}>‹</PaginationButton>),
	Next: React.forwardRef((props, ref) => <PaginationButton ref={ref} {...props}>›</PaginationButton>),
	Last: React.forwardRef((props, ref) => <PaginationButton ref={ref} {...props}>»</PaginationButton>),
	Ellipsis: () => <span className="inline-flex size-10 items-center justify-center text-muted-foreground">…</span>,
});

export const Alert = ({ variant = "danger", className, ...props }) => (
	<div
		role="alert"
		className={cn(
