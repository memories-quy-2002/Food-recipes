...
const Footer = (): ReactElement => {
	...
	const { about, contact, primaryNavigation, secondaryNavigation, follow, bottom } =
		siteContent;
	const linkClass =
		"inline-flex min-h-11 items-center rounded-md px-1 text-sm text-muted-foreground transition hover:text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring";
	return (
