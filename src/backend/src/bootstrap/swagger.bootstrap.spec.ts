...
describe('Swagger document', () => {
  ...
  it('publishes the versioned public route inventory and metadata', async () => {
    ...
    const expectedRoutes = [
      ...
      'POST /api/v1/users/me/cooking-session/{sessionId}/complete',
      'DELETE /api/v1/users/me/cooking-session/{sessionId}',
      'POST /api/v1/media/recipe-image/upload-url',
      'POST /api/v1/media/journal-photo/upload-url',
      ...
      'POST /api/v1/users/me/recipe-imports/preview',
      'POST /api/v1/users/me/recipe-imports/drafts',
      ...
      'PATCH /api/v1/households/{householdId}/pantry/{pantryId}',
      'DELETE /api/v1/households/{householdId}/pantry/{pantryId}',
      'POST /api/v1/households/{householdId}/pantry/from-shopping-list',
      'GET /api/v1/households/{householdId}/meal-plans',
      'POST /api/v1/households/{householdId}/meal-plans',
      'GET /api/v1/households/{householdId}/meal-plans/{planId}',
      'PATCH /api/v1/households/{householdId}/meal-plans/{planId}',
      'DELETE /api/v1/households/{householdId}/meal-plans/{planId}',
      'POST /api/v1/households/{householdId}/meal-plans/{planId}/items',
      'PATCH /api/v1/households/{householdId}/meal-plans/{planId}/items/{itemId}',
      'DELETE /api/v1/households/{householdId}/meal-plans/{planId}/items/{itemId}',
      'GET /api/v1/households/{householdId}/shopping-list',
      'POST /api/v1/households/{householdId}/shopping-list/items',
      'PATCH /api/v1/households/{householdId}/shopping-list/items/{itemId}',
