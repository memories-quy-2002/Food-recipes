	...
	return (
		<Container fluid className="food">
			...
			<div className="food__intro">
				...
				<div className="food__summary" aria-label="Recipe library summary"><div><strong>{recipesQuery.data?.length || 0}</strong><span>Recipes in view</span></div><div><strong>{categories.length}</strong><span>Categories</span></div><div><strong>{meals.length}</strong><span>Meal types</span></div></div>
			</div>
