...
- [x] **Step 1: Write the failing hierarchy tests**
...
- [x] **Step 3: Implement the minimal hierarchy and responsive styles**
...
- [x] **Step 4: Run the focused recipe tests to verify GREEN**
...
- [x] **Step 1: Write failing FilterSheet tests**
...
- [x] **Step 3: Implement the sheet and mobile trigger**
...
- [x] **Step 4: Run FilterSheet and existing Food tests to verify GREEN**
...
- [x] **Step 1: Write failing chip tests**
...
- [x] **Step 3: Implement chips and result-toolbar placement**
...
- [x] **Step 4: Add and run the Playwright journey**
...
- [x] Run focused tests, full frontend `test:ci`, lint, typecheck, build, and Phase 4/5 Playwright plus existing planning/shopping journeys.
- [x] Run backend typecheck and `prisma validate`; backend source must remain unchanged.
- [x] Run `git diff --check` and inspect staged files.
- [x] Stage only Phase 4/5 docs, Recipe detail, Food filter components, tests, and E2E files.
